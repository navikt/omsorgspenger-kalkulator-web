...
export const TrashCan: React.FunctionComponent<OwnProps> = ({ height, width }) => {
  return (
    <svg enable-background='new 0 0 48 48' width={`${width}px`} height={`${height}px`} version='1.1' viewBox='0 0 48 48'
         xmlSpace='preserve'
